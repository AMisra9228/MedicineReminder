...
public class Medicine {
    ...
    private int id,c_snooze,repetition,occurrence;

    public Medicine(String med_name, String med_des, String start_date,String next_date,String end_date,int repetition,int occurrence,String sleep_from,String sleep_to,String med_status,int c_snooze) {
    ...
    public void setNextTime(String next_date) {
        this.next_date = next_date;
    }
    ...
    public void setReptition(int repetition) {
        this.repetition = repetition;
    }
