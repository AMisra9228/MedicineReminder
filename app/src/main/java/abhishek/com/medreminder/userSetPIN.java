...
public class userSetPIN extends AppCompatActivity implements View.OnClickListener {
...
//                    toSpeech.speak(text,TextToSpeech.QUEUE_FLUSH,null);
//                }
                sp.Speech(userSetPIN.this,"Re-enter PIN to enable app");
...
//                        m_report1 = sharedpreferences.getString("m_report", null);
                        ...
                        editor.putString("sleep_to", "00:00");
                        editor.putString("sleep_fto", "00:00");
...
//                            toSpeech.speak(text,TextToSpeech.QUEUE_FLUSH,null);
//                        }
                        sp.Speech(userSetPIN.this,"PIN Enabled Successfully");
...
//                        startActivity(intent1.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Intent i = new Intent(userSetPIN.this,MainActivity.class);
...
//                            toSpeech.speak(text,TextToSpeech.QUEUE_FLUSH,null);
//                        }
                        sp.Speech(userSetPIN.this,"PIN doesn't match. Try Again");
