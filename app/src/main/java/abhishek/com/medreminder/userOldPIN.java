...
public class userOldPIN extends AppCompatActivity implements View.OnClickListener {

    SharedPreferences sharedpreferences;
    private String mypreference = "login_pin";
    private static final String TAG = "userOldPIN";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text = "Enter current 4-digit-PIN";
        tv.setText(""  + text);
        ...
        if (pinLength != prev) {
            if (pinLength < 4) {
                ...
                if(m_pin.equals(current_pin)) {
                    ...
                    Intent intent1 = new Intent(userOldPIN.this, userNewPIN.class);
...
//                    startActivity(intent1);
    ...
    public void onBackPressed() {
        ...
        Intent intent =new Intent(userOldPIN.this,PasswordSettingsActivity.class);
