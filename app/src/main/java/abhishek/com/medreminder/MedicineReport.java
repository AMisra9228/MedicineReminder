...
public class MedicineReport {
    ...
    private String med_name, med_des, next_date, end_date, next_time,end_time,sleep_from,sleep_to,med_status;
    private Date next_dat, end_dat;
    private int med_id,c_snooze,occurrence;

    public MedicineReport(Integer med_id, String med_name, String med_des, String next_date,String end_date,int occurrence,String sleep_from,String sleep_to,String med_status,int c_snooze) {
        this.med_id = med_id;
    ...
    public String getStartDate() { return next_date; }

    public void setStartDate(String next_dat) { this.next_date = next_date; }
